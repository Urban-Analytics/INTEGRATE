...
### Visualization
### Figure 1: Accuracy heatmap across temperature and top_p, faceted by top_k
...
### Figure 2: Macro-F1 heatmap (temp. * top_p, faceted by top_k)
...
### Figure 3a: Scatter plot (Accuracy vs Macro-F1, size = MCC)
...
### Figure 3b: Scatter plot with jitter (same as p3a, but jittered)
